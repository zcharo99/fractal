...
library.themes = {
    {
        ...
        theme = {
            ...
            ["Risky Text"]                = fromrgb(65, 43, 107);
            ["Risky Text Enabled"]        = fromrgb(65, 43, 107);
        }
    },
    {
        name = 'Informant_V1',
...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "zcharo99"});
    ...
    mainSection:AddToggle({text = 'Disable Movement', flag = 'disablemenumovement', tooltip = "Disables movement if ui is open", callback = function(bool)
